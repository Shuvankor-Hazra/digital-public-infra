...
const HowDoWe = () => {
    ...
    return (
        <div className='max-w-screen-xl w-[90%] py-5 mx-auto lg:my-20 my-10'>
            <div>
                <h2 className='text-[30px] lg:text-[44px] uppercase leading-[36px] font-light text-center mb-5'>
                    How do we<br />
            ...
            <div>
                <div role="tablist" className="relative justify-center lg:space-x-10 tabs">
                    <label
                        className={`tab text-xs lg:text-[20px] text-gray-500 ${activeTab === 'discover' ? ' text-black border-b-8 pb-[62px] border-[#139cd8]' : 'pb-[70px]'}`}
                        aria-label="Discover"
                    ...
                    <label
                        className={`tab text-xs lg:text-[20px] text-gray-500 ${activeTab === 'design' ? ' text-black border-b-8 pb-[62px] border-[#139cd8]' : 'pb-[70px]'}`}
                        aria-label="Design"
                        onClick={() => setActiveTab('design')}
                    >
                        <img src={DesignSvg} alt="Design icon" className="inline-block w-8 h-8 lg:mr-5 lg:w-12 lg:h-12" />
                        <span>Design</span>
                    </label>

                    <label
                        className={`tab text-xs lg:text-[20px] text-gray-500 ${activeTab === 'implement' ? ' text-black border-b-8 pb-[62px] border-[#139cd8]' : 'pb-[70px]'}`}
                        aria-label="Implement"
                        onClick={() => setActiveTab('implement')}
                    >
                        <img src={ImplementSvg} alt="Implement icon" className="inline-block w-8 h-8 lg:mr-5 lg:w-12 lg:h-12" />
                        <span>Implement</span>
                    </label>

                    <label
                        className={`tab text-xs lg:text-[20px] text-gray-500 ${activeTab === 'evolve' ? 'text-black border-b-8 pb-[62px] border-[#139cd8]' : 'pb-[70px]'}`}
                        aria-label="Evolve"
                        onClick={() => setActiveTab('evolve')}
                    >
                        <img src={EvolveSvg} alt="Evolve icon" className="inline-block w-8 h-8 lg:mr-5 lg:w-12 lg:h-12" />
                        <span>Evolve</span>
                    </label>
